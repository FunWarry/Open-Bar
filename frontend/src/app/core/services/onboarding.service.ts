...
export class OnboardingService {
  ...
  getStepsForRole(role: string): OnboardingStep[] {
    const commonWelcome: OnboardingStep = {
      id: 'welcome',
      ...
      case 'ADMIN':
        return [
          commonWelcome,
          {
            ...
            roleTarget: 'ADMIN',
            featureHighlightsKeys: [
              'ONBOARDING.ADMIN_USERS_FEAT_1',
              'ONBOARDING.ADMIN_USERS_FEAT_2'
            ],
          ...
          },
          {
            ...
            roleTarget: 'ADMIN',
            featureHighlightsKeys: [
              'ONBOARDING.ADMIN_SETUP_FEAT_1',
              'ONBOARDING.ADMIN_SETUP_FEAT_2'
            ],
      ...
      case 'MANAGER':
        return [
          commonWelcome,
          {
            ...
            roleTarget: 'MANAGER',
            featureHighlightsKeys: [
              'ONBOARDING.MANAGER_DASHBOARD_FEAT_1',
              'ONBOARDING.MANAGER_DASHBOARD_FEAT_2'
            ],
            routeAction: '/manager'
          },
          {
            ...
            roleTarget: 'MANAGER',
            featureHighlightsKeys: [
              'ONBOARDING.MANAGER_RECAP_FEAT_1',
              'ONBOARDING.MANAGER_RECAP_FEAT_2'
            ],
      ...
      case 'SERVEUR':
        return [
          commonWelcome,
          {
            ...
            roleTarget: 'SERVEUR',
            featureHighlightsKeys: [
              'ONBOARDING.SERVEUR_PLAN_FEAT_1',
              'ONBOARDING.SERVEUR_PLAN_FEAT_2'
            ],
            routeAction: '/serveur'
          },
          {
            ...
            roleTarget: 'SERVEUR',
            featureHighlightsKeys: [
              'ONBOARDING.SERVEUR_ORDER_FEAT_1',
              'ONBOARDING.SERVEUR_ORDER_FEAT_2'
            ],
      ...
      case 'BARMAN':
        return [
          commonWelcome,
          {
            ...
            roleTarget: 'BARMAN',
            featureHighlightsKeys: [
              'ONBOARDING.BARMAN_KANBAN_FEAT_1',
              'ONBOARDING.BARMAN_KANBAN_FEAT_2'
            ],
            routeAction: '/barman'
          },
          {
            ...
            roleTarget: 'BARMAN',
            featureHighlightsKeys: [
              'ONBOARDING.BARMAN_STOCK_FEAT_1',
              'ONBOARDING.BARMAN_STOCK_FEAT_2'
            ],
      ...
      default:
        return [
          commonWelcome,
          {
            ...
            roleTarget: 'CLIENT',
            featureHighlightsKeys: [
              'ONBOARDING.CLIENT_MENU_FEAT_1',
              'ONBOARDING.CLIENT_MENU_FEAT_2'
            ],
