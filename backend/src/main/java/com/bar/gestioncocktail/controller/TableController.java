...
public class TableController {
    ...
    public TableEntity createTable(@Valid @RequestBody TableEntity table) {
        return tableService.createTable(table);
    }

    @PutMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN') or hasRole('MANAGER')")
    public ResponseEntity<TableEntity> updateTable(@PathVariable Long id, @Valid @RequestBody TableEntity tableDetails) {
