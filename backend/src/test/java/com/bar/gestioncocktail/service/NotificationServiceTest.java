...
class NotificationServiceTest {
    ...
    void notifierStatutCommande_envoyeSurTopicCommandeAvecId() {
        ...
        // Uses reflection to set the ID (no public setter generated by Lombok)
        try {
    ...
    void notifierStockFaible_payloadContientLesDonneesIngredient() {
        ...
        // Checks data via reflection (private inner class StockAlerteNotification)
        try {
    ...
    void notifierStockFaible_stockNegatif_envoyeToutDeMeme() {
        // Service does not filter negative values — it delegates to STOMP/message broker
